...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel5.Init.Request = GPDMA1_REQUEST_I2C3_TX;
  ...
  */
    ...
    PB7     ------> I2C4_SDA
    */
    GPIO_InitStruct.Pin = MISC_SCL_Pin|MISC_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    handle_GPDMA1_Channel7.Init.Request = GPDMA1_REQUEST_I2C4_RX;
    ...
    __HAL_LINKDMA(hi2c, hdmarx, handle_GPDMA1_Channel7);
    ...
    handle_GPDMA1_Channel6.Init.Request = GPDMA1_REQUEST_I2C4_TX;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PB7     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(MISC_SCL_GPIO_Port, MISC_SCL_Pin);

    HAL_GPIO_DeInit(MISC_SDA_GPIO_Port, MISC_SDA_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = FLOW_SCK_Pin|FLOW_MISO_Pin|FLOW_MOSI_Pin;
    ...
    __HAL_LINKDMA(hspi, hdmarx, handle_GPDMA1_Channel10);
    ...
    __HAL_LINKDMA(hspi, hdmatx, handle_GPDMA1_Channel9);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, FLOW_SCK_Pin|FLOW_MISO_Pin|FLOW_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = SERVO3_Pin|SERVO2_Pin|SERVO1_Pin|ESC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, ESP_RXD_Pin|ESP_TXD_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(GPS_RXD_GPIO_Port, GPS_RXD_Pin);

    HAL_GPIO_DeInit(GPS_TXD_GPIO_Port, GPS_TXD_Pin);
